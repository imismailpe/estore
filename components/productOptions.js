    ...
    return (
        <div className={styles.productOptions}>
            ...
            <div className={styles.inputSection}>
                ...
                <input name="cost" type="number" value={product.cost} onChange={e => saveProductOptionValues(product.id, 'cost', e.target.value)} />
            </div>
            <div className={styles.inputSection}>
                <label htmlFor="sellingprice">Selling price</label>
                <input name="sellingprice" type="number" value={product.sellingPrice} onChange={e => saveProductOptionValues(product.id, 'sellingPrice', e.target.value)} />
            </div>
            <div className={styles.inputSection}>
                <label htmlFor="mrp">MRP</label>
                <input name="mrp" type="number" value={product.mrp} onChange={e => saveProductOptionValues(product.id, 'mrp', e.target.value)}/>
            </div>
            <div className={styles.inputSection}>
            ...
            <div className={styles.inputSection}>
                ...
                <input name="quantity" type="number" value={product.quantity} onChange={e => saveProductOptionValues(product.id, 'quantity', e.target.value)}/>
            </div>
            <div className={styles.inputSection}>
